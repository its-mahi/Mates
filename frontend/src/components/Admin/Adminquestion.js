...
export default function Adminquestion() {
    ...
    const fetchAllFilteredQuestions = async () => {
        const response = await fetch(`http://localhost:8000/api/question/fetchUserFilteredQuestions`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/api/question/usedtags`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
      ...
      const FindFrequencyOfAns = async () => {
        const response = await fetch("http://localhost:8000/api/answer/findNumberOfAns", {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const fetchVotes = async()=>{
        ...
        const response = await fetch(`http://localhost:8000/api/question/fetchallVotes`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
