...
export default function UserProfileAnalysis() {
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/api/question/fetchUserQuestions/${username}`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/api/answer/fetchUserAcceptedAnsweredQuestions/${username}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/api/answer/fetchUserAnsweredQuestions/${username}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
