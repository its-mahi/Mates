...
export default function Analysis() {
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/api/answer/fetchUserAcceptedAnsweredQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/api/answer/fetchUserAnsweredQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
