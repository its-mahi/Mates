...
export default function Tags() {
  ...
  const fetchTags = async () => {
    await fetch("http://localhost:8000/api/tag/gettag", {
      method: "POST",
      headers: {
                      ...
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          <NavLink
                            ...
                            Style="color:hsl(205,47%,42%); background-color: hsl(205,46%,92%); border-radius:5px; display:inline;"
                          >
                            {tag.tagname}
                          </NavLink>
                          <p className="card-text m-2">
                            {tag.desc.slice(0, 100)}...
                          </p>
                        </div>
                      </div>
                    </div>
